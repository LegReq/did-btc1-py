...
async def resolve_example():
    ...
    did = "did:btc1:k1qgp29g4mp94dx7z980je9y958d08pfm0z9ytqfeaz5us5h0qnhzw0xsd4sa3r"
    ...
    resolver = Btc1Resolver(rpc_endpoint=rpc_endpoint, rpcuser="polarpass", rpcpassword="polarpass")

    document = await resolver.resolve(did, resolution_options)

    print("Resolved Document", document)
